prefectures = ['Hokkaido', 'Hokkaido', 'Toyko', 'Kanagawa']
cities = ['Spporo', 'Hakodate', 'Minato', 'Yokohama']
...
I = 3
J = 3
multiplicated_xy_dict = {i:{j:(i*j) for j in range(J)} for j in range(J) for i in range(I)}
print(multiplicated_xy_dict)
